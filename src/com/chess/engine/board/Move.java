...
public abstract class Move {
    ...
    public Board execute() {
        ...
        builder.setPiece(this.movedPiece.movePiece(this)); //This will represent the moved piece after it's made its move
        builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance()); //If the incoming call to execute was white then this line changes it to black
    ...
    public static final class PawnJump extends Move{
        ...
        public Board execute(){
            ...
            builder.setEnPassantPawn(movedPawn); //Would be null if no pawn jump occurs which can be used to our advantage
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
    ...
    static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movePiece(this)); //Manually move the king, but create a new Rook in the castle position
            //TO DO, Look into the first move for the Rook
