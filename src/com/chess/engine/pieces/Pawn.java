...
public class Pawn extends Piece{
    ...
    public Collection<Move> calculateLegalMoves(final Board board) {
        ...
        for (final int currentCandidateOffset : CANDIDATE_MOVE_COORDINATE){
            ...
            final int candidateDestinationCoordinate = this.piecePosition + (this.pieceAlliance.getDirection() * currentCandidateOffset); //Gets the correct direction depending on alliance
            ...
            if (currentCandidateOffset == 8 && !board.getTile(candidateDestinationCoordinate).isTileOccupied()){
                //MORE WORK TO DO HERE WITH PROMOTIONS
                    ...
                    !((BoardUtils.EIGHTH_COLUMN[this.piecePosition] && this.pieceAlliance.isWhite() ||
                        ...
                        if (board.getTile(candidateDestinationCoordinate).isTileOccupied()){
                            ...
                            if(this.pieceAlliance != pieceOnCandidate.getPieceAlliance()){
                                //TO DO MORE HERE DEALING WITH PROMOTIONS DURING ATTACKING
                                legalMoves.add(new MajorMove(board, this, candidateDestinationCoordinate));
                            }
                        }
